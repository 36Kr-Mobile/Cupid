...
class SimpleNetworking: CupidNetworkingProvider {

    static let sharedInstance = SimpleNetworking()
    private let session = NSURLSession.sharedSession()
    
    func request(URL: NSURL, method: CupidNetworkingMethod, parameters: [String:AnyObject]? = nil, completionHandler: NetworkResponseHandler) {
    ...
    func request(URLString: String, method: CupidNetworkingMethod, parameters: [String:AnyObject]? = nil, completionHandler: NetworkResponseHandler) {
        guard let URL = NSURL(string: URLString) else {
            print("URL init Error: URLString")
            return
        }

        Cupid.networkingProvier.request(URL, method: method, parameters: parameters, completionHandler: completionHandler)
    }
    ...
    private func encode(URLRequest: NSMutableURLRequest, parameters: [String:AnyObject]?) -> NSURLRequest {
        ...
        let method = CupidNetworkingMethod(rawValue: mutableURLRequest.HTTPMethod)!
    ...
    private func urlRequestWithComponents(URLString: String, parameters: [String:AnyObject]) -> (request:NSURLRequest?, data:NSData?) {
        ...
        let mutableURLRequest = NSMutableURLRequest(URL: URL)
        mutableURLRequest.HTTPMethod = CupidNetworkingMethod.POST.rawValue
